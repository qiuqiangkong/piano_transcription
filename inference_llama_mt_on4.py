...
def inference_in_batch(args):
    ...
    checkpoint_path = Path("checkpoints/train_llama_mt_on4/AudioLlama/step=40000_encoder.pth")
    ...
    # Load checkpoint
    checkpoint_path = Path("checkpoints/train_llama_mt_on4/AudioLlama/step=40000.pth")
    config = LLaMAConfig(
