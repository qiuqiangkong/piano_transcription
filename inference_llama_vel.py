...
def inference_in_batch(args):
    ...
    checkpoint_path = Path("checkpoints/train_llama_vel/AudioLlama/step=70000_encoder.pth")
    ...
    # Load checkpoint
    checkpoint_path = Path("checkpoints/train_llama_vel/AudioLlama/step=70000.pth")
    config = LLaMAConfig(
    ...
    onset_midis_dir = Path("pred_midis", model_name)
