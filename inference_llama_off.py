...
def inference_in_batch(args):
    ...
    checkpoint_path = Path("checkpoints/train_llama_off/AudioLlama/step=8000_encoder.pth")
    ...
    # Load checkpoint
    checkpoint_path = Path("checkpoints/train_llama_off/AudioLlama/step=8000.pth")
    config = LLaMAConfig(
    ...
    vel_midis_dir = Path("pred_midis_vel", model_name)
    offset_midis_dir = Path("offset_midis_vel", model_name)
