...
def inference_in_batch(args):
    ...
    checkpoint_path = Path("checkpoints/train_llama_mt_vel2/AudioLlama/step=90000_encoder.pth")
    ...
    # Load checkpoint
    checkpoint_path = Path("checkpoints/train_llama_mt_vel2/AudioLlama/step=90000.pth")
    config = LLaMAConfig(
    ...
    onset_midis_dir = Path("pred_midis", "inference_llama_mt_on")
