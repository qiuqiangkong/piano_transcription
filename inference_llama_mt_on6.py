...
from models.enc_dec import EncDecConfig, EncDec
...
def inference_in_batch(args):
    ...
    checkpoint_path = Path("checkpoints/train_llama_mt_on6/AudioLlama/step=50000_encoder.pth")
    ...
    # Load checkpoint
    checkpoint_path = Path("checkpoints/train_llama_mt_on6/AudioLlama/step=50000.pth")
    config = EncDecConfig(
