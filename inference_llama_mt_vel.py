...
def inference_in_batch(args):
    ...
    checkpoint_path = Path("checkpoints/train_llama_mt_vel/AudioLlama/step=80000_encoder.pth")
    ...
    # Load checkpoint
    checkpoint_path = Path("checkpoints/train_llama_mt_vel/AudioLlama/step=80000.pth")
    config = LLaMAConfig(
