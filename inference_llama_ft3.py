...
def inference_in_batch(args):
    ...
    checkpoint_path = Path("checkpoints/train_llama_ft3/CRnn3_onset_offset_vel/step=180000_encoder.pth")
    ...
    # Load checkpoint
    checkpoint_path = Path("checkpoints/train_llama_ft3/CRnn3_onset_offset_vel/step=180000.pth")
    config = LLaMAConfig(
