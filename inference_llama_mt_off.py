...
def inference_in_batch(args):
    ...
    checkpoint_path = Path("checkpoints/train_llama_mt_off/AudioLlama/step=100000_encoder.pth")
    ...
    # Load checkpoint
    checkpoint_path = Path("checkpoints/train_llama_mt_off/AudioLlama/step=100000.pth")
    config = LLaMAConfig(
